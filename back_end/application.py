...
while True:
    ...
    try:
        ...
        conn = psycopg2.connect(
            host='db',
            database='placement_test_db',
            user='admin',
            password='it490PasswordG4'
        )
...
insert_query = """INSERT INTO users (username, password,first_name, last_name) VALUES ('faltu', 'dummypass', 'bob', 'topa')"""
